  ...
  <section className ="mb-32 text-gray-800">
    ...
    <div className =" uno grid lg:grid-cols-3 px-6 md:px-12 xl:px-32" >
      <div className =" pricing1" >
        <div className ="block pricingBorder rounded-lg shadow-lg bg-white h-full lg:rounded-tr-none lg:rounded-br-none" ref={ref} style={style}>
          <div className ="p-6 border-b border-gray-300 text-center">
            <p className ="uppercase mb-4 text-sm">
              <strong>Basic</strong>
            </p>
            <Link href="https://api.whatsapp.com/send?phone=5491123597015&text=Estoy interesada/o en el plan basic" passHref target="blank" rel="noreferrer">
            <button type="button"
      ...
      <div className =" pricing2">
        <div className ="block pricingBorder rounded-lg shadow-lg bg-white h-full z-10" ref={ref2} style={style2}>
          <div className ="p-6 border-b border-gray-300 text-center">
            ...
            <Link href="https://api.whatsapp.com/send?phone=5491123597015&text=Estoy interesada/o en el plan enterprise" passHref target="blank" rel="noreferrer">
              <button type="button"
      ...
      <div className=" pricing3">
        <div className="block pricingBorder rounded-lg shadow-lg bg-white h-full lg:rounded-tl-none lg:rounded-bl-none" ref={ref3} style={style3}>
          <div className="p-6 border-b border-gray-300 text-center">
            ...
            <Link href="https://api.whatsapp.com/send?phone=5491123597015&text=Estoy interesada/o en el plan advance" passHref target="blank" rel="noreferrer">
              <button type="button"
              className="dos inline-block px-6 py-2.5 bg-transparent text-blue-600 font-medium text-xs leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out w-full"
              data-mdb-ripple="true" data-ripple-color="primary">
              Consultanos
          ...
          <ol className ="list-inside">
              ...
              <li className ="mb-4 flex items-center">
                <svg color="green" width={16} height={16} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check"
