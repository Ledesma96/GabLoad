...
const Pricing = () => {
  ...
  return (
    <div className="container my-24 px-6 mx-auto " id="pricing">
      <section className="mb-32 text-gray-800" style={{marginLeft: "-100px"}}>
        <div
          id="pricing-block-5"
        ...
        <div className=" uno grid lg:grid-cols-3 px-6 md:px-12 xl:px-32">
          <div className="pricing1">
            <div
              className="block pricingBorder rounded-lg shadow-lg bg-white h-full lg:rounded-tr-none lg:rounded-br-none"
              ref={ref}
              style={style}
            >
              <div className="p-6 border-b border-gray-300 text-center">
                ...
                <Link
                  href="https://api.whatsapp.com/send?phone=5491123597015&text=Estoy interesada/o en el plan basic"
                  passHref
                  target="blank"
                  rel="noreferrer"
                >
              ...
              <div className="p-6">
                <ol className="list-inside">
                  ...
                  <li className="mb-4 flex items-center">
                    ...
                    <p className="svg__p">Hosting gratis por 6 meses</p>
                  </li>
                  <li className="mb-4 flex items-center">
                    <svg
                      className="nope"
                    ...
                    <p className="svg__p">Certificado de Sitio Seguro (SSL)</p>
                  </li>
                  <li className="mb-4 flex items-center">
                    <svg
                      aria-hidden="true"
                  ...
                  <li className="mb-4 flex items-center">
                    ...
                    <p className="svg__p">Enlaces directos a redes sociales</p>
                  </li>
                  <li className="mb-4 flex items-center">
                    <svg
                      className="nope"
            ...
            <Image
              width={30}
              height={30}
              className={vermas ? "arriba" : "abajo"}
              src={"/arrow.png"}
              onClick={handleClick}
              alt="icono de ver mas y ocultar"
            />
          </div>
          <div className=" pricing2">
            <div
              className="block pricingBorder rounded-lg shadow-lg bg-white h-full z-10"
              ref={ref2}
              style={style2}
            >
              <div className="p-6 border-b border-gray-300 text-center">
                ...
                <Link
                  href="https://api.whatsapp.com/send?phone=5491123597015&text=Estoy interesada/o en el plan enterprise"
                  passHref
                  target="blank"
                  rel="noreferrer"
                >
              ...
              <div className="p-6">
                <ol className="list-inside">
                  ...
                  <svg
                    ...
                    <p className="svg__p">Botón flotante de WhatsApp</p>
                  </li>
                </ol>
              </div>
            </div>
            <Image
              width={30}
              height={30}
              className={vermas2 ? "arriba" : "abajo"}
              src={"/arrow.png"}
          ...
          <div className=" pricing3">
            <div
              className="block pricingBorder rounded-lg shadow-lg bg-white h-full lg:rounded-tl-none lg:rounded-bl-none"
              ref={ref3}
              style={style3}
            >
              <div className="p-6 border-b border-gray-300 text-center">
                ...
                <Link
                  href="https://api.whatsapp.com/send?phone=5491123597015&text=Estoy interesada/o en el plan advance"
                  passHref
                  target="blank"
                  rel="noreferrer"
                >
            ...
            <Image
              width={30}
              height={30}
              className={vermas3 ? "arriba" : "abajo"}
              src={"/arrow.png"}
